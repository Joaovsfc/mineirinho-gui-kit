...
router.post('/register', async (req, res) => {
  try {
    ...
    // Se is_admin for true, verificar se o usuário que está criando é admin
    // Por enquanto, vamos permitir apenas se não houver usuários ou se for explicitamente permitido
    // Em produção, isso deve verificar o token de autenticação
